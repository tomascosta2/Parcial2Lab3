...
const editPedidoById = async (id: string): Promise<void> => {
    ...
    if (fechaPedido) {
        ...
        (form.querySelector<HTMLInputElement>('input#idcliente') as HTMLInputElement).value = idcliente || '';
        (form.querySelector<HTMLInputElement>('input#fechaPedido') as HTMLInputElement).value = fechaCorrecta;
        (form.querySelector<HTMLInputElement>('input#nroComprobante') as HTMLInputElement).value = nroComprobante || '';
        (form.querySelector<HTMLInputElement>('input#formaPago') as HTMLInputElement).value = formaPago || '';
        (form.querySelector<HTMLInputElement>('textarea#observaciones') as HTMLInputElement).value = observaciones || '';
        (form.querySelector<HTMLInputElement>('input#totalPedido') as HTMLInputElement).value = totalPedido || '';
    }
